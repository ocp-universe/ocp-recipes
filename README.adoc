...
Configure the 'values.yaml' in link:02-cluster-config[Cluster Config] to select the desired state (and capabilities). Some capability examples are in link:03-cluster-capabilities[Cluster Capabilities], any other repository is how ever possible.
